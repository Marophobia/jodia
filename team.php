                ...
                <div class="row mt-n1-9">
                    ...
                    <div class="col-md-6 col-xl-3 mt-1-9 wow fadeIn" data-wow-delay="100ms">
                        <div class="card card-style07 border-0">
                            <div class="team-before-hover">
                                <div class="team-img rounded-top">
                                    <img src="img/team/team-05.jpg" alt="..." class="rounded-top">
                                </div>
                            </div>
                            <div class="card-body position-relative">
                                <div class="team-social">
                                ...
                                <h3 class="h5 mb-1"><a href="team-details.html">Selam Mewael</a></h3>
                                <span>Contractor</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-3 mt-1-9 wow fadeIn" data-wow-delay="100ms">
                        <div class="card card-style07 border-0">
                            <div class="team-before-hover">
                                <div class="team-img rounded-top">
                                    <img src="img/team/team-06.jpg" alt="..." class="rounded-top">
                                </div>
                            </div>
                            <div class="card-body position-relative">
                                <div class="team-social">
                                ...
                                <h3 class="h5 mb-1"><a href="team-details.html">Temesgen Efrem</a></h3>
                                <span>Contractor</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-3 mt-1-9 wow fadeIn" data-wow-delay="100ms">
                        <div class="card card-style07 border-0">
                            <div class="team-before-hover">
                                <div class="team-img rounded-top">
                                    <img src="img/team/team-07.jpg" alt="..." class="rounded-top">
                                </div>
                            </div>
                            <div class="card-body position-relative">
                                <div class="team-social">
                                ...
                                <h3 class="h5 mb-1"><a href="team-details.html">Saare Tewolde</a></h3>
                                <span>Manager</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-3 mt-1-9 wow fadeIn" data-wow-delay="100ms">
                        <div class="card card-style07 border-0">
                            <div class="team-before-hover">
                                <div class="team-img rounded-top">
                                    <img src="img/team/team-08.jpg" alt="..." class="rounded-top">
                                </div>
                            </div>
                            <div class="card-body position-relative">
                                <div class="team-social">
                                ...
                                <h3 class="h5 mb-1"><a href="team-details.html">Selamawit Tesfay</a></h3>
                                <span>CEO</span>
                            </div>
                        </div>
                    </div>
