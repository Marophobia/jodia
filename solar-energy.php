...
<!-- Mirrored from metaryhtml.websitelayout.net/civil-engineering.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Oct 2025 11:41:28 GMT -->
	...
	<script type="application/ld+json">
{
 ...
 "url": "https://www.jodiaenergies.com/solar-energy",
                        ...
                        <div class="service-sidebar me-xxl-1-9">
                            <div class="bg-light p-1-6 mb-2-6 rounded wow fadeIn" data-wow-delay="200ms">
                                ...
                                <ul class="cetegory p-0 list-unstyled mb-0">
                                    ...
                                    <li class="active"><a href="solar-energy.php" class="mb-0">Solar Energy Solutions <i
                                                class="ti-angle-right"></i></a></li>
                                </ul>
                            </div>
                    ...
                    <div class="col-lg-8 mt-1-9 order-1 order-lg-2">
                        <div>
                            <div class="mb-1-9 mb-xl-5 text-center wow fadeIn" data-wow-delay="200ms">
                                <img src="img/service/service-details-06.jpg" alt="Solar panel installation"
                                    class="rounded">
                            </div>
                            ...
                            <p class="mb-2-3 wow fadeIn" data-wow-delay="200ms">Our comprehensive solar offerings
                                ...
                                site assessments to recommend the most efficient and scalable solar solutions, ensuring
                                maximum return on investment. With Jodia Energies, you are choosing a partner committed
                                to innovation and energy independence.</p>
                            <div class="wow fadeIn" data-wow-delay="200ms">
                                <h2 class="h3 mb-4">Benefits of Adopting Solar Energy</h2>
                                <p class="mb-1-9">Transitioning to solar energy with Jodia Energies provides a multitude
                                    of benefits, including significant reductions in electricity bills, protection
                                    against rising energy costs, and a substantial decrease in your carbon footprint.
                                    Our reliable solar systems offer energy independence and continuous power supply,
                                    crucial for uninterrupted business operations and comfortable living.</p>
                            </div>
                            <div class="row mb-1-9">
                                <div class="col-md-6 wow fadeIn" data-wow-delay="200ms">
                                    <div class="d-flex align-items-center mb-4">
                                        <i class="ti-check display-26 text-primary"></i>
                                        <span class="ms-3 text-secondary fw-bold">Reduced Electricity Costs & Energy
                                            Bills</span>
                                    </div>
                                    <div class="d-flex align-items-center mb-4 mb-md-0">
                                        <i class="ti-check display-26 text-primary"></i>
                                        <span class="ms-3 text-secondary fw-bold">Reliable & Consistent Power
                                            Supply</span>
                                    </div>
                                </div>
                                <div class="col-md-6 wow fadeIn" data-wow-delay="200ms">
                                    <div class="d-flex align-items-center mb-4">
                                        <i class="ti-check display-26 text-primary"></i>
                                        <span class="ms-3 text-secondary fw-bold">Lower Carbon Footprint & Environmental
                                            Impact</span>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <i class="ti-check display-26 text-primary"></i>
                                        <span class="ms-3 text-secondary fw-bold">Increased Property Value & Energy
                                            Independence</span>
                                    </div>
                                </div>
                            </div>
                            <p class="mb-0 wow fadeIn" data-wow-delay="200ms">Embrace the future of energy with Jodia
                                Energies & Logistics Ltd. Our expertise in solar solutions ensures you receive a
                                high-performing, durable, and sustainable energy system that meets your current and
                                future power requirements.</p>
                        </div>
                    </div>
                </div>
            </div>
